...
const ShopPage = () => {
  ...
  const filteredStocks = stocks.filter(
    (stock) => stock.variety === "Pachcha" && stock.cropType.toLowerCase() === filter.toLowerCase()
  );
  ...
  const getProductImage = (variety) => {
    ...
    return varietyMap[variety] || '/shopImg/pachcha.jpg'; // Default image if variety not found
  };
    ...
    <div className={`bg-gradient-to-br ${getBackgroundGradient()} min-h-screen font-sans`}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 flex items-center text-sm text-gray-600">
          ...
          <FaChevronRight className="mx-2 text-xs" />
          <span className="text-gray-800 font-medium">Pachcha</span>
        </div>
        ...
        <section className="relative mb-16 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute top-1/2 transform -translate-y-1/2 left-12 z-20 text-white max-w-lg">
            ...
            >
              <h1 className="text-5xl sm:text-6xl font-extrabold mb-4 drop-shadow-lg">Pachcha</h1>
        ...
        <div className="mb-20">
          {loading ? (
            ...
            <div className="text-center py-16 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg">
              ...
              <h2 className="text-2xl font-bold text-gray-700 mb-2">No Pachcha {filter.toLowerCase()} available</h2>
            ...
            >
              <h2 className="text-3xl font-bold mb-8 text-center">Available Pachcha {filter}</h2>
