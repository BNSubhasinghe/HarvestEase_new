  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        <h2 className="text-3xl font-bold mb-6 text-white bg-black bg-opacity-60 px-4 py-2 rounded">
          Crop Data Charts 📊
        </h2>

        <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-md max-w-6xl w-full flex flex-col md:flex-row justify-center gap-6">
          {/* Bar Chart */}
          <div className="w-full md:w-1/2 h-96">
            <h3 className="text-xl font-semibold text-center mb-4">Land Area by Paddy Type</h3>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={landAreaData}>
                <XAxis dataKey="paddyType" />
                <YAxis />
                <Tooltip />
          ...
          {/* Pie Chart */}
          <div className="w-full md:w-1/2 h-96">
            <h3 className="text-xl font-semibold text-center mb-4">Crop Count by Paddy Type</h3>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={cropCountData}
